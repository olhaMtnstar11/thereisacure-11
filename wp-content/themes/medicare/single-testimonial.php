		...
		<div class="container">
			<div class="row">
					...
					while ( have_posts() ) { the_post(); $post_id = get_the_ID();
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
							<div class="ro-sub-article">
								...
								<div class="ro-meta">
									<span><?php _e( '<strong>Age:</strong> ', 'medicare' ); echo get_post_meta( get_the_ID(), 'tb_testimonial_age', true ); ?></span>
									<span><?php _e( '<strong>Company:</strong> ', 'medicare' ); echo get_post_meta( get_the_ID(), 'tb_testimonial_company', true ); ?></span>
								</div>
								<?php the_content(); ?>
							</div>
						</article>
				...
				<div class="col-md-4 sidebar-right">
					<h6 class="ro-related-title"><?php _e('TESTIMONIAL lIST', 'medicare') ?></h6>
