...
if ( ! function_exists( 'ro_theme_author_render' ) ) {
	function ro_theme_author_render() {
		...
		<?php if ( is_sticky() && is_home() && ! is_paged() ) { ?>
			<span class="featured-post"> <?php _e( 'Sticky', 'medicare' ); ?></span>
		<?php } ?>
	...
	<div class="ro-comment">
		<div class="ro-comment-inner">
			...
			<?php if ( $comment->comment_approved == '0' ) : ?>
				<em class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'medicare' ); ?></em>
				<br />
			<?php endif; ?>
			<span class="ro-time">
				...
				<?php edit_comment_link( __( '(Edit)', 'medicare' ), '  ', '' ); ?>
			</span>
