...
class tbFrameworkMetaboxes {
	public function __construct(){
		...
		if(function_exists('jws_add_meta_boss')) {
            jws_add_meta_boss(array($this, 'jws_add_meta_boss'));
        }
	...
	public function jws_add_meta_boss()
	{
		$post_types = get_post_types( array( 'public' => true ) );
		$this->add_meta_boss2('post_options', __('Page Options','medicare'), 'page');
		$this->add_meta_boss2('post_video', __('Video Settings','medicare'), 'post');
		$this->add_meta_boss2('post_audio', __('Audio Settings','medicare'), 'post');
		$this->add_meta_boss2('post_quote', __('Quote Settings','medicare'), 'post');
		$this->add_meta_boss2('post_link', __('Link Settings','medicare'), 'post');
		$this->add_meta_boss2('post_testimonial', __('Testimonial Settings','medicare'), 'testimonial');
		$this->add_meta_boss2('post_doctor', __('Doctor Settings','medicare'), 'doctor');
	}
	...
	public function add_meta_boss2($id, $label, $post_type)
	{
		jws_add_meta_boss2(
		'tb_' . $id,
		$label,
