...
vc_add_param ( "vc_row", array (
		"type" 			=> "textfield",
		"class" 		=> "",
		"heading" 		=> __( "Id One Page", 'medicare' ),
		"param_name" 	=> "id_onepage",
		"value" 		=> "",
		"description" 	=> __( "Please, Enter row id one page.", 'medicare' )
) );
vc_add_param ( 'vc_row', array (
		'type' 			=> 'checkbox',
		'heading' 		=> __("Row Full Height", 'medicare'),
		'param_name' 	=> 'full_height',
		"value" 		=> array (
							__( "Yes, please", 'medicare' )  => 1
						),
		'description' 	=> __("Set full height screen of this row.", 'medicare')
) );
vc_add_param ( "vc_row", array (
		"type" 			=> "dropdown",
		"class" 		=> "",
...
vc_add_param ( "vc_row", array (
		...
		"value" 		=> "",
		"description" 	=> __( "Select color for all text in this row.", 'medicare' )
) );
vc_add_param ( "vc_row", array (
		"type" 			=> "colorpicker",
		"class" 		=> "",
...
vc_add_param ( "vc_row", array (
		...
		"description" 	=> __( "Select effect in this row.", 'medicare' )
) );
vc_add_param ( "vc_row", array (
		"type" 			=> "checkbox",
		"class" 		=> "",
...
vc_add_param ( "vc_progress_bar", array (
		...
		"description" => __( "Select style progress bar.", 'medicare' )
) );
vc_add_param ( "vc_progress_bar", array (
		"type" => "dropdown",
		"class" => "",
		"heading" => __( "Size", 'medicare' ),
		"admin_label" => true,
		"param_name" => "size",
		"value" => array (
				"Small" => "small",
		...
		"description" => __( "Select size progress bar.", 'medicare' )
) );
vc_add_param ( "vc_progress_bar", array (
		"type" => "dropdown",
		"class" => "",
		"heading" => __( "Unit Align", 'medicare' ),
		"admin_label" => true,
		...
		"description" => __( "Select position unit in progerss bar.", 'medicare' )
) );
//Button
vc_add_param ( "vc_button", array (
		...
		"description" => __( "Select type of button.", 'medicare' )
) );
//Pie & Counter
vc_add_param ( "vc_pie", array (
		...
		"description" => __( "Select type.", 'medicare' )
) );
vc_add_param ( "vc_pie", array (
		"type" => "textfield",
		"class" => "",
		"heading" => __( "Title Size", 'medicare' ),
		"param_name" => "title_size",
		"value" => "",
		"description" => __( "Select font size of title widget.", 'medicare' )
) );
vc_add_param ( "vc_pie", array (
		"type" => "textfield",
		"class" => "",
		"heading" => __( "Font Size", 'medicare' ),
		...
		"description" => __( "Select font size of counter value.", 'medicare' )
) );
vc_add_param ( "vc_pie", array (
		"type" => "attach_image",
		"class" => "",
		...
		"description" => __( "Select image of pie.", 'medicare' )
) );
...
vc_add_param ( "vc_accordion", array (
		...
		"description" => __( "Select Style of accordion.", 'medicare' )
) );