	...
	<div class="<?php echo esc_attr(implode(' ', $class)); ?>">
		<div class="ro-find-doctor-form">
			<form action="" method="post">
				<div class="row">
					<div class="col-md-6">
						<h6 class="ro-color-main"><?php _e('Search by Department', 'medicare') ?></h6>
						<select class="ro-doctor-department" name="ro-doctor-department">
							<option value=""><?php _e('All Department', 'medicare') ?></option>
							<?php
					...
					<div class="col-md-6">
						<h6><?php _e('Search by Doctor\'s name', 'medicare') ?></h6>
				...
				<div class="row">
					<div class="col-md-12">
						<h6 class="ro-color-main"><?php _e('Alphabetical Search', 'medicare') ?></h6>
				...
				<div class="row">
					<div class="col-md-12">
						<h6 class="ro-color-main"><?php _e('Select Hospital', 'medicare') ?></h6>
						<?php
						$terms = get_terms('doctor_hospital', 'orderby=count&hide_empty=0');
						if ( ! empty( $terms ) && ! is_wp_error( $terms ) ){
							foreach($terms as $term) {
			...
			<?php if(isset($_POST['ro-doctor-department'])) { ?>
				...
				<?php if($wp_query->have_posts()) { $count_result = 0;?>
					...
					<div class="ro-header clearfix">
						<h4 class="pull-left"><?php _e('SEARCH RESULT', 'medicare') ?></h4>
				...
				<?php }else { ?>
					<h1><?php _e('Nothing Found', 'medicare') ?></h1>
				<?php } ?>
			<?php } else { ?>
				<?php if($wp_query->have_posts()) { ?>
					<div class="ro-header clearfix">
						<h4 class="pull-left"><?php _e('ALL RESULT', 'medicare') ?></h4>
