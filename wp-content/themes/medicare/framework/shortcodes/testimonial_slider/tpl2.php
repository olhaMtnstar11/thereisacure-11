	...
	<ul class="slides">
		<?php while ( $wp_query->have_posts() ) { $wp_query->the_post(); ?>
			...
			<li class="ro-testimonial-slider-item" data-thumb="<?php echo esc_url($attachment_image[0]); ?>">
				...
				<div class="ro-arrow-down"><span class="ro-line-left"></span><span><img src="<?php echo esc_url(URI_PATH.'/assets//images/arrow-down.png'); ?>"></span><span class="ro-line-right"></span></div>
				<div class="ro-info-wrap clearfix">
