									...
									<div class="ro-doctor-item clearfix">
										...
										<div class="ro-doctor-content">
											...
											<div class="ro-buttons">
												<a class="ro-appointment" href="<?php echo esc_url($appoitment_link); ?>"><?php _e('MAKE AN APPOINTMENT', 'medicare'); ?></a>
												<a class="ro-profile" href="<?php the_permalink(); ?>"><?php _e('VIEW PROFILE', 'medicare'); ?></a>
											</div>
										</div>
									</div>
								</article>
